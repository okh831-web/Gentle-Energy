    ...
    <div className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mb-16">
          <h2 className="text-sm font-bold text-emerald-700 uppercase tracking-widest mb-3">About</h2>
          <h3 className="text-4xl font-bold text-slate-900">교육성과관리와 AI 교수설계를 연결하는 교육학 연구자/실천가</h3>
          <p className="text-xl text-slate-600 leading-relaxed italic">
            "교육혁신은 아이디어로 끝나면 남는 것이 없다. 수업과 제도가 바뀌고, 그 변화가 데이터로 확인될 때 지속된다."
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          <div className="space-y-12">
            <div>
              <h4 className="text-lg font-bold text-slate-900 border-l-4 border-emerald-600 pl-4 mb-6">연구 철학</h4>
              ...
              <div className="mt-8 pt-6 border-t border-slate-100">
                ...
                <a href="mailto:okh831@naver.com" className="text-lg font-bold text-emerald-700 hover:underline">okh831@naver.com</a>
              </div>
            </div>

            <div>
              <h4 className="text-lg font-bold text-slate-900 border-l-4 border-emerald-600 pl-4 mb-6">경력 타임라인</h4>
          ...
          <div className="bg-slate-50 p-10 rounded-2xl">
            <h4 className="text-lg font-bold text-slate-900 mb-8">핵심 강점</h4>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="bg-white p-6 rounded-xl border border-slate-200">
                  <div className="text-emerald-600 font-bold mb-2">0{i+1}</div>
                  <div className="text-slate-900 font-bold mb-2">{strength.title}</div>
                  <div className="text-slate-500 text-sm leading-snug">{strength.desc}</div>
                </div>
              ))}
            </div>
            
            <div className="mt-12 p-6 bg-emerald-900 text-white rounded-xl">
              <h5 className="font-bold mb-2">함께 고민하겠습니다.</h5>
